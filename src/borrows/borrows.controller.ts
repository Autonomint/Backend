...
export class BorrowsController {
  ...
  @Get('/deposit')
  getDepositsById(
    @Body() getBorrowDeposit: GetBorrowDeposit,
  ): Promise<BorrowInfo> {
  ...
  getDepositorIndexByAddress(
    @Param() params: { address: string; chainId: number },
  ): Promise<number> {
  ...
  getEthVolatility(
    ...
    return this.borrowsService.getEthVolatility(
      chainId,
      amount,
      ethPrice,
      strikePricePercent,
  ...
  getRatio(
    @Param() params: { chainId: number; ethPrice: number },
  ): Promise<number> {
    const chainId = params.chainId;
    const ethPrice = params.ethPrice;
  ...
  getOptionFeesHistory(
    @Param() params: { chainId: number; days: number; allTime: AllTime },
  ): Promise<number[]> {
    const chainId = params.chainId;
